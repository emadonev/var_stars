...
\begin{figure*}[ht]
    ...
    \caption{The figure shows selection criteria and the resulting numbers of pre-selected Blazhko star candidates for each
      ...
      example, a total of 116 stars passed the LZ5 criterion, however, 14 of them only satisfied LZ5, while 33 satisfied LZ5 and had
      a significant amplitude change, 22 had a significant period difference as well, and finally 47 had a significant period and amplitude difference
      along with the satisfied LZ5 criterion. If we add all the specific cases together for LZ5, we would get a sum of 116.}
      \label{fig:selstats}
    \end{figure*}
