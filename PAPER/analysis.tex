...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=17cm]{stats_categories.png}
...
\begin{figure*}[ht]
  ...
  \caption{Phase 2 of visual analysis of Blazhko candidates. XXX Are these LINEAR and ZTF periodograms?
       Is this figure a bit redundant with the previous figure? }
    \label{fig:phase2}
\end{figure*}
...
% is LINEAR ID= 1092244 could example for Blazhko beating?
