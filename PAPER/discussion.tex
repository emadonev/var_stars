...
%%% MAIN CONCLUSIONS
%% - a lower limit of 11\% for the incidence rate of Blazhko stars
%% - ab type Blazhko stars have about 5% shorter periods 
%% - Blazhko effect appears not stationary on time scales shorter than a decade
%% 


%% these datasets are not perfect, especially compared to LSST 

%% one would want to look at neighboring objects to confirm photometric quality
%% as well as at images to test hypothesis that we have an isolated point source
%% (e.g. blended object photometry can be affected by variable seeing beyond
%%  aperture correction valid for isolated point sources 
...
centered on 48 d and 186 d.
 ...
 %Although close to 8,000 Blazhko stars were discovered or confirmed in the Galactic bulge and LMC/SMC by
% the OGLE-III survey, only about 200 stars have been reported in all field RR Lyrae stars studies to date;
